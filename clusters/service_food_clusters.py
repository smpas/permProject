...
service_clusterization = services_clusterization.ServicesClusterization(city_model).get_clusters_polygon(
    service_types=['bakery', 'barpub', 'cafe', 'fast_food', 'restaurant'], n_std=2, condition_value=2000
    )
...
geo_j = folium.GeoJson(
    ...
    tooltip=folium.features.GeoJsonTooltip(['bakery', 'barpub', 'cafe', 'fast_food', 'restaurant'])
).add_to(map)
...
map.save("clusters/food_clusters.html")