...
service_clusterization = services_clusterization.ServicesClusterization(city_model).get_clusters_polygon(
    service_types=['cinema', 'nightclub', 'mall', 'museum', 'theatre', 'zoo', 'community_center', 'gallery'], n_std=2, condition_value=1000
    )
...
geo_j = folium.GeoJson(
    ...
    tooltip=folium.features.GeoJsonTooltip(['cinema', 'nightclub', 'mall', 'museum', 'theatre', 'zoo', 'community_center', 'gallery'])
).add_to(map)
